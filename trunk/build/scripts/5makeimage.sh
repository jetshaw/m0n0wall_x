...
makemfsroot generic-pc-cf 4096
makemfsroot generic-pc-usb 4096

# Make firmware img with 2MB space 	
#makeimage generic-pc 2048
#makeimage generic-pc-serial 2048
#makeimage generic-pc-cdrom 2048
makeimage generic-pc-cf 2048
makeimage generic-pc-usb 2048
...
#    -c "boot/boot.catalog" -r -publisher "m0n0.ch" \
