...
# check whether the kernel has been built.
if [ ! -e  "$MW_BUILDPATH/tmp/kernel_build_flag" ]; then
...
# set the built flag of kernel
	touch $MW_BUILDPATH/tmp/kernel_build_flag
fi
